...
import static org.sn.common.runtime.TVMTestUtils.generateDeploySmartContractAndGetTransaction;
import static org.sn.common.runtime.TVMTestUtils.generateTriggerSmartContractAndGetTransaction;
...
public class RuntimeImplTest {
  ...
  public void init() {
    ...
    dbManager.getDynamicPropertiesStore().saveTotalEnergyWeight(5_000_000_000L); // unit is sn
  ...
  public void getCreatorEnergyLimit2Test() {
    ...
    Transaction sn = generateDeploySmartContractAndGetTransaction(contractName, creatorAddress,
        ABI,
        code, value, feeLimit, consumeUserResourcePercent, libraryAddressPair);

    RuntimeImpl runtimeImpl = new RuntimeImpl(sn, null, deposit, new ProgramInvokeFactoryImpl(),
        true);
  ...
  public void getCallerAndCreatorEnergyLimit2With0PercentTest()
    ...
    Contract.TriggerSmartContract contract = ContractCapsule.getTriggerContractFromTransaction(sn);
