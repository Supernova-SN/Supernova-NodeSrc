...
import stest.sn.wallet.common.client.utils.DataWord;
...
public class RuntimeTransferComplexTest {
   ...
   */
  @Test
  public void TransferSnToContractAccountWhenDeployAContract()
    ...
    Transaction sn = TVMTestUtils.generateDeploySmartContractAndGetTransaction(
    ...
    runtime = TVMTestUtils.processTransactionAndReturnRuntime(sn, deposit, null);
  ...
  @Test
  public void TransferSnToContractAccountFailIfNotPayable()
      throws ContractExeException, ReceiptCheckErrException, ContractValidateException, VMIllegalException {
   ...
   */
  @Test
  public void TransferSnToContractAccountWhenTriggerAContract()
      throws ContractExeException, ReceiptCheckErrException, ContractValidateException, VMIllegalException {
  ...
  public void TransferCallValueTestWhenUsingCallAndCreate()
    ...
    byte[] createdAddress = convertToSnAddress(
    ...
    byte[] createdAddress2 = convertToSnAddress(
        new DataWord(runtime.getResult().getHReturn()).getLast20Bytes());
    ...
    byte[] createdAddress3 = convertToSnAddress(
        new DataWord(runtime.getResult().getHReturn()).getLast20Bytes());
    Assert.assertTrue(Hex.toHexString(new DataWord(createdAddress2).getLast20Bytes())
        .equalsIgnoreCase("0000000000000000000000000000000000000000"));
    Assert.assertTrue(runtime.getRuntimeError().contains("Invalid operation code: opCode[fe];"));
