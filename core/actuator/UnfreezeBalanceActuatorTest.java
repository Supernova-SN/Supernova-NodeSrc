...
import org.sn.core.capsule.DelegatedResourceAccountIndexCapsule;
import org.sn.core.capsule.DelegatedResourceCapsule;
...
public class UnfreezeBalanceActuatorTest {
  ...
  private Any getContractForCpu(String ownerAddress) {
    return Any.pack(
        Contract.UnfreezeBalanceContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(ownerAddress)))
            .setResource(org.sn.protos.Contract.ResourceCode.ENERGY)
            .build());
  }
  ...
  public void testUnfreezeBalanceForBandwidth() {
    ...
    Assert.assertEquals(accountCapsule.getSnPower(), frozenBalance);
    ...
    try {
      ...
      Assert.assertEquals(owner.getSnPower(), 0L);
  ...
  public void testUnfreezeDelegatedBalanceForBandwidth() {
    ...
    Assert.assertEquals(frozenBalance, owner.getSnPower());
    ...
    Assert.assertEquals(0L, receiver.getSnPower());
    ...
    try {
      ...
      Assert.assertEquals(0L, ownerResult.getSnPower());
