...
import org.sn.core.capsule.ExchangeCapsule;
...
public class ExchangeTransactionActuatorTest {
  ...
  private void InitExchangeBeforeSameTokenNameActive() {
    ...
    ExchangeCapsule exchangeCapsule =
        new ExchangeCapsule(
            ...
            "_".getBytes(),
            "abc".getBytes());
    exchangeCapsule.setBalance(1_000_000_000_000L, 10_000_000L); // 1M SN == 10M abc
    ...
    ExchangeCapsule exchangeCapsule3 =
        new ExchangeCapsule(
            ...
            "_".getBytes(),
            "1".getBytes());
    exchangeCapsule3.setBalance(1_000_000_000_000L, 10_000_000L); // 1M SN == 10M abc
  ...
  public void SameTokenNameCloseSuccessExchangeTransaction() {
    ...
    long exchangeId = 1;
    String tokenId = "_";
    long quant = 100_000_000L; // use 100 SN to buy abc
