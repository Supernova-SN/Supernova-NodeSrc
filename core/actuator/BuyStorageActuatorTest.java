...
public class BuyStorageActuatorTest {
  ...
  public void testBuyStorage() {
    ...
    long quant = 2_000_000_000_000L; // 2 million sn
  ...
  public void testBuyStorage2() {
    ...
    long quant = 1_000_000_000_000L; // 1 million sn
...
//    Assert.assertEquals(currentReserved, 128L * 1024 * 1024 * 1024);
//
//    long quant = 1_000_000_000_000L; // 2 million sn
//
//    BuyStorageActuator actuator = new BuyStorageActuator(
//        getContract(OWNER_ADDRESS, quant), dbManager);
//    TransactionResultCapsule ret = new TransactionResultCapsule();
...
//  }
  ...
  public void buyLessThan1Sn() {
    ...
    try {
      ...
      Assert.assertTrue(e instanceof ContractValidateException);
      Assert.assertEquals("quantity must be larger than 1SN", e.getMessage());
    } catch (ContractExeException e) {
      Assert.assertFalse(e instanceof ContractExeException);
    }
  }
  ...
  public void buyLessThan1Byte() {
    ...
    long quant = 9_000_000_000_000_000L; // 9 billion sn
