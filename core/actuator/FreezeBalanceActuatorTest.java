...
import org.sn.core.config.Parameter.ChainConstant;
...
import org.sn.protos.Contract.ResourceCode;
...
public class FreezeBalanceActuatorTest {
  ...
  public void lessThan1SnTest() {
    ...
    try {
      ...
      Assert.assertTrue(e instanceof ContractValidateException);
      Assert.assertEquals("frozenBalance must be more than 1SN", e.getMessage());
    } catch (ContractExeException e) {
      Assert.assertFalse(e instanceof ContractExeException);
    }
  }
