...
//    Transaction.Builder snBuilder = Transaction.newBuilder();
...
//    snBuilder.setRawData(rawBuilder);
//    AccountStore accountStore = dbManager.getAccountStore();
//    TransactionCapsule transactionCapsule = new TransactionCapsule(snBuilder.build());
//    //Accout not exist
//    try {
...
//      Assert.assertEquals(e.getMessage(), "Signature size is " + "test".length());
//    }
//    //transaction already have a signature signed by a invalidate key that the key is not in the permission.
//    transactionCapsule = new TransactionCapsule(transferContract, accountStore);
//    List<byte[]> prikeys = new ArrayList<>();
//    prikeys.add(ByteArray.fromHexString(KEY_11));
...
//    //SignatureFormatException
//    ByteString test = ByteString.copyFromUtf8("test");
//    snBuilder.clearSignature().addSignature(test);
//    try {
//      TransactionCapsule.validateSignature(snBuilder.build(), hash, accountStore);
//      Assert.assertFalse(true);
//    } catch (SignatureException e) {
//      Assert.assertFalse(true);
//    } catch (PermissionException e) {
...
//    new Random().nextBytes(rand);
//    rand[64] = 8;  // v = 8 < 27 v += 35 > 35
//    snBuilder.clearSignature().addSignature(ByteString.copyFrom(rand));
//    try {
//      TransactionCapsule.validateSignature(snBuilder.build(), hash,
//          accountStore);
//      Assert.assertFalse(true);
//    } catch (SignatureException e) {
//      Assert.assertEquals(e.getMessage(), "Header byte out of range: 35");
...
//    snBuilder.clearSignature().addAllSignature(sign21_11);
//    try {
//      TransactionCapsule.validateSignature(snBuilder.build(), hash, accountStore);
//      Assert.assertFalse(true);
//    } catch (SignatureException e) {
...
//    snBuilder.clearSignature().addAllSignature(sign21_11_22_23);
//    try {
//      TransactionCapsule
//          .validateSignature(snBuilder.build(), hash, accountStore);
//      Assert.assertFalse(true);
//    } catch (SignatureException e) {
//      Assert.assertFalse(true);
//    } catch (PermissionException e) {
...
//    snBuilder.clearSignature().addAllSignature(sign21_22_21);
//    try {
//      TransactionCapsule
//          .validateSignature(snBuilder.build(), hash, accountStore);
//      Assert.assertFalse(true);
...
//    snBuilder.clearSignature().addAllSignature(sign21);
//    try {
...
//    snBuilder.clearSignature().addAllSignature(sign21_22);
//    try {
//      boolean result = TransactionCapsule
//          .validateSignature(snBuilder.build(), hash, accountStore);
...
//    snBuilder.clearSignature().addAllSignature(sign21_22_23);
//    try {
//      boolean result = TransactionCapsule
//          .validateSignature(snBuilder.build(), hash, accountStore);
//      Assert.assertTrue(result);
...
//    ArrayList<ByteString> sign = sign(prikeys, Sha256Hash.hash(rawBuilder.build().toByteArray()));
//    snBuilder.addAllSignature(sign);
//    transactionCapsule = new TransactionCapsule(snBuilder.build());
//
//    // no contract
//    prikeys.clear();
//    prikeys.add(ByteArray.fromHexString(KEY_21));
//    snBuilder = Transaction.newBuilder();
...
//    snBuilder = transactionCapsule.getInstance().toBuilder();
//    //SignatureFormatException
//    ByteString test = ByteString.copyFromUtf8("test");
//    snBuilder.clearSignature();
//    snBuilder.addSignature(test);
//    transactionCapsule = new TransactionCapsule(snBuilder.build());
//    try {
//      transactionCapsule.validateSignature(dbManager);
//      Assert.assertFalse(true);
...
//    rand[64] = 8;  // v = 8 < 27 v += 35 > 35
//    snBuilder.clearSignature();
//    snBuilder.addSignature(ByteString.copyFrom(rand));
//    transactionCapsule = new TransactionCapsule(snBuilder.build());
//    try {
//      transactionCapsule.validateSignature(dbManager);
//      Assert.assertFalse(true);
...
//    ArrayList<ByteString> sign21_11 = sign(prikeys, hash);
//    snBuilder.clearSignature();
//    snBuilder.addAllSignature(sign21_11);
//    transactionCapsule = new TransactionCapsule(snBuilder.build());
//    try {
//      transactionCapsule.validateSignature(dbManager);
//      Assert.assertFalse(true);
...
//    ArrayList<ByteString> sign21_11_22_23 = sign(prikeys, hash);
//    snBuilder.clearSignature();
//    snBuilder.addAllSignature(sign21_11_22_23);
//    transactionCapsule = new TransactionCapsule(snBuilder.build());
//    try {
//      transactionCapsule.validateSignature(dbManager);
//      Assert.assertFalse(true);
...
//    ArrayList<ByteString> sign21_22_21 = sign(prikeys, hash);
//    snBuilder.clearSignature();
//    snBuilder.addAllSignature(sign21_22_21);
//    transactionCapsule = new TransactionCapsule(snBuilder.build());
//    try {
//      transactionCapsule.validateSignature(dbManager);
//      Assert.assertFalse(true);
...
//    ArrayList<ByteString> sign21 = sign(prikeys, hash);
//    snBuilder.clearSignature();
//    snBuilder.addAllSignature(sign21);
//    transactionCapsule = new TransactionCapsule(snBuilder.build());
//    try {
//      transactionCapsule.validateSignature(dbManager);
//      Assert.assertFalse(true);
...
//    ArrayList<ByteString> sign21_22 = sign(prikeys, hash);
//    snBuilder.clearSignature();
//    snBuilder.addAllSignature(sign21_22);
//    transactionCapsule = new TransactionCapsule(snBuilder.build());
//    try {
...
//    ArrayList<ByteString> sign21_22_23 = sign(prikeys, hash);
//    snBuilder.clearSignature();
//    snBuilder.addAllSignature(sign21_22_23);
//    transactionCapsule = new TransactionCapsule(snBuilder.build());
//    try {
//      boolean result = transactionCapsule.validateSignature(dbManager);
//      Assert.assertTrue(result);
