...
import static org.sn.core.net.message.MessageTypes.P2P_DISCONNECT;
import static org.sn.core.net.message.MessageTypes.P2P_HELLO;
import static org.sn.protos.Protocol.ReasonCode.DUPLICATE_PEER;
import static org.sn.protos.Protocol.ReasonCode.FORKED;
import static org.sn.protos.Protocol.ReasonCode.INCOMPATIBLE_CHAIN;
import static org.sn.protos.Protocol.ReasonCode.INCOMPATIBLE_VERSION;
...
import org.sn.common.overlay.discover.node.Node;
import org.sn.common.overlay.message.DisconnectMessage;
import org.sn.common.overlay.message.HelloMessage;
import org.sn.common.overlay.message.Message;
import org.sn.common.overlay.message.P2pMessage;
import org.sn.common.overlay.message.P2pMessageFactory;
import org.sn.common.overlay.server.ChannelManager;
import org.sn.common.overlay.server.SyncPool;
import org.sn.common.utils.ReflectUtils;
import org.sn.core.capsule.BlockCapsule;
import org.sn.core.capsule.BlockCapsule.BlockId;
...
public class TcpTest {
  ...
  private SnNetDelegate tronNetDelegate;
  ...
  public TcpTest(SnApplicationContext context) {
    channelManager = context.getBean(ChannelManager.class);
    manager = context.getBean(Manager.class);
    pool = context.getBean(SyncPool.class);
    tronNetDelegate = context.getBean(SnNetDelegate.class);
  }
