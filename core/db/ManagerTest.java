...
import org.sn.core.exception.AccountResourceInsufficientException;
import org.sn.core.exception.BadBlockException;
import org.sn.core.exception.BadItemException;
import org.sn.core.exception.BadNumberBlockException;
import org.sn.core.exception.ContractExeException;
import org.sn.core.exception.ContractValidateException;
import org.sn.core.exception.DupTransactionException;
import org.sn.core.exception.HeaderNotFound;
import org.sn.core.exception.ItemNotFoundException;
import org.sn.core.exception.NonCommonBlockException;
import org.sn.core.exception.ReceiptCheckErrException;
import org.sn.core.exception.TaposException;
import org.sn.core.exception.TooBigTransactionException;
import org.sn.core.exception.TooBigTransactionResultException;
import org.sn.core.exception.TransactionExpirationException;
import org.sn.core.exception.UnLinkedBlockException;
import org.sn.core.exception.VMIllegalException;
import org.sn.core.exception.ValidateScheduleException;
import org.sn.core.exception.ValidateSignatureException;
import org.sn.core.witness.WitnessController;
...
public class ManagerTest {
  ...
  public void setBlockReference()
    ...
    if (dbManager.getDynamicPropertiesStore().getLatestBlockHeaderNumber() == 0) {
      ...
      dbManager.setBlockReference(sn);
      Assert.assertEquals(1,
          ByteArray.toInt(sn.getInstance().getRawData().getRefBlockBytes().toByteArray()));
    }
