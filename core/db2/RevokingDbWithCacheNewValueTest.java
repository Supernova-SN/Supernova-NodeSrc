...
import org.sn.core.db.SnStoreWithRevoking;
...
import org.sn.core.exception.RevokingStoreIllegalStateException;
...
public class RevokingDbWithCacheNewValueTest {
  ...
  public synchronized void testPop() throws RevokingStoreIllegalStateException {
    ...
    tronDatabase = new TestRevokingSnStore("testRevokingDBWithCacheNewValue-testPop");
  ...
  public synchronized void testMerge() {
    revokingDatabase = new TestSnapshotManager();
    revokingDatabase.enable();
    tronDatabase = new TestRevokingSnStore("testRevokingDBWithCacheNewValue-testMerge");
    revokingDatabase.add(tronDatabase.getRevokingDB());
  ...
  public synchronized void testRevoke() {
    revokingDatabase = new TestSnapshotManager();
    revokingDatabase.enable();
    tronDatabase = new TestRevokingSnStore("testRevokingDBWithCacheNewValue-testRevoke");
    revokingDatabase.add(tronDatabase.getRevokingDB());
  ...
  public synchronized void testGetlatestValues() {
    revokingDatabase = new TestSnapshotManager();
    revokingDatabase.enable();
    tronDatabase = new TestRevokingSnStore("testSnapshotManager-testGetlatestValues");
    revokingDatabase.add(tronDatabase.getRevokingDB());
    while (revokingDatabase.size() != 0) {
      revokingDatabase.pop();
    }
  ...
  public synchronized void testGetValuesNext() {
    revokingDatabase = new TestSnapshotManager();
    revokingDatabase.enable();
    tronDatabase = new TestRevokingSnStore("testSnapshotManager-testGetValuesNext");
    revokingDatabase.add(tronDatabase.getRevokingDB());
    while (revokingDatabase.size() != 0) {
      revokingDatabase.pop();
    }
  ...
  public static class TestRevokingSnStore extends SnStoreWithRevoking<ProtoCapsuleTest> {

    protected TestRevokingSnStore(String dbName) {
      super(dbName);
    }
