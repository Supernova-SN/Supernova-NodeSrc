package stest.sn.wallet.contract.scenario;
...
import stest.sn.wallet.common.client.Configuration;
import stest.sn.wallet.common.client.Parameter.CommonConstant;
import stest.sn.wallet.common.client.utils.Base58;
import stest.sn.wallet.common.client.utils.PublicMethed;
...
public class ContractScenario013 {
  ...
  @Test(enabled = true)
  public void deploySnSnAndSunContract() {
    ...
    String contractName = "SnSnAndSunContract";
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractScenario013_deploySnSnAndSunContract");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractScenario013_deploySnSnAndSunContract");
  ...
  @Test(enabled = true)
  public void triggerSnSnAndSunContract() {
    AccountResourceMessage accountResource = PublicMethed.getAccountResource(contract013Address,
        blockingStubFull);
    Long energyLimit = accountResource.getEnergyLimit();
    Long energyUsage = accountResource.getEnergyUsed();
    ...
    String contractName = "SnSnAndSunContract";
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractScenario013_triggerSnSnAndSunContract");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractScenario013_triggerSnSnAndSunContract");
