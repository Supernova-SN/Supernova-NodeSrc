package stest.sn.wallet.newaddinterface2;
...
import stest.sn.wallet.common.client.utils.TransactionUtils;

//import stest.sn.wallet.common.client.AccountComparator;
...
public class UpdateAccount2Test {
  ...
  @Test(enabled = true)
  public void testNoBalanceTransferSn2() {
  ...
  public Boolean createAssetIssue(byte[] address, String name, Long totalSupply, Integer snNum,
